...
class BankAccount8 {
    ...
    BankAccount8(String cName, String cId) {
        customerName = cName;
        customerId = cId;
    }
    ...
    public void transfer(double amount, BankAccount8 acc) {
        if (this.balance < amount) {
            clrscr();
            System.out.println("=================================");
            ...
            do {
                ...
                switch (option) {
                    ...
                    case 'E':
                        ...
                        BankAccount8 bb = new BankAccount8("Abhishek", "1813");
...
class ATM{
    public static void main(String[] args) {
        BankAccount8 ba = new BankAccount8("Abhishek", "1813");
        ba.checkId();
    }
}